    ...
    <div className="rounded-xl shadow-lg overflow-hidden" style={{ height: '500px' }}>
      ...
      >
        ...
        {stations.map((station) => {
          ...
          // Construir el enlace a Google Maps
          const googleMapsUrl = `https://www.google.com/maps/dir/?api=1&destination=${stationLat},${stationLon}&travelmode=driving`;

          return (
            <Marker key={station.IDEESS} position={[stationLat, stationLon]} icon={markerIcon}>
              <Popup>
                <div className="p-2 flex flex-col items-center">
                  <h3 className="font-bold text-gray-900 text-center">{station.Rótulo}</h3>
                  <p className="text-sm text-gray-700 text-center">{station.Dirección}</p>
